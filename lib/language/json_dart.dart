...
class JsonLanguage {
  ...
  /// return original data json
  static JsonLanguage create({
    String special_type = "JsonLanguage",
  }) {
    Map jsonCreate = {
      "@type": special_type,
    };
    ...
    return JsonLanguage(jsonCreate);
  }
...
extension JsonLanguageExtensions on List<JsonLanguage> {
  List<Map> toJson() {
